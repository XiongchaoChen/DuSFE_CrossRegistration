...
class GuidedBackPropagation(BackPropagation):
    def __init__(self, model):
        ...
        for module in self.model.named_modules():
            handle = module[1].register_backward_hook(func_b)
...
class GradCAM(_PropagationBase):
    def __init__(self, model):
        ...
        self.handles = []
        for module in self.model.named_modules():
            self.handles.append(module[1].register_forward_hook(func_f))
            self.handles.append(module[1].register_backward_hook(func_b))
